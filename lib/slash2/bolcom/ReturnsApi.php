...
class ReturnsApi
{
     ...
     * Create return
     *
     * @param  \Bolcom\Client\Model\CreateReturnRequest $body body (optional)
     *
     ...
     * Create return
     *
     * @param  \Bolcom\Client\Model\CreateReturnRequest $body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\ModelReturn|\Bolcom\Client\Model\Problem
     */
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\ModelReturn|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReturnWithHttpInfo($return_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bolcom\Client\Model\ModelReturn' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Bolcom\Client\Model\ModelReturn', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\Bolcom\Client\Model\ModelReturn';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bolcom\Client\Model\ModelReturn',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\ReturnsResponse|\Bolcom\Client\Model\Problem
     */
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\ReturnsResponse|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReturnsWithHttpInfo($page = 1, $handled = null, $fulfilment_method = 'FBR')
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bolcom\Client\Model\ReturnsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Bolcom\Client\Model\ReturnsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Bolcom\Client\Model\ReturnsResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bolcom\Client\Model\ReturnsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Bolcom\Client\Model\ReturnRequest $body The handling result requested by the retailer. (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\ProcessStatus|\Bolcom\Client\Model\Problem
