...
class RetailerOffer implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets ean
     *
     * @param string|null $ean The EAN number associated with this product. Note: in case an ISBN is provided, the ISBN will be replaced with the actual EAN belonging to this ISBN.
     *
     * @return self
     */
