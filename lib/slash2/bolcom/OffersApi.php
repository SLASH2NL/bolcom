...
class OffersApi
{
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\RetailerOffer|\Bolcom\Client\Model\Problem
     */
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\RetailerOffer|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOfferWithHttpInfo($offer_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bolcom\Client\Model\RetailerOffer' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Bolcom\Client\Model\RetailerOffer', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\Bolcom\Client\Model\RetailerOffer';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bolcom\Client\Model\RetailerOffer',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Create a new offer
     *
     * @param  \Bolcom\Client\Model\CreateOfferRequest $body body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\ProcessStatus|\Bolcom\Client\Model\Problem
     ...
     * Create a new offer
     *
     * @param  \Bolcom\Client\Model\CreateOfferRequest $body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\ProcessStatus|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \Bolcom\Client\Model\CreateOfferExportRequest $body body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\ProcessStatus|\Bolcom\Client\Model\Problem
     ...
     * Request an offer export file
     *
     * @param  \Bolcom\Client\Model\CreateOfferExportRequest $body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\ProcessStatus|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  string $offer_id Unique identifier for an offer. (required)
     * @param  \Bolcom\Client\Model\UpdateOfferRequest $body body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\ProcessStatus|\Bolcom\Client\Model\Problem
     ...
     *
     * @param  string $offer_id Unique identifier for an offer. (required)
     * @param  \Bolcom\Client\Model\UpdateOfferRequest $body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\ProcessStatus|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  string $offer_id Unique identifier for an offer. (required)
     * @param  \Bolcom\Client\Model\UpdateOfferPriceRequest $body body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\ProcessStatus|\Bolcom\Client\Model\Problem
     ...
     *
     * @param  string $offer_id Unique identifier for an offer. (required)
     * @param  \Bolcom\Client\Model\UpdateOfferPriceRequest $body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\ProcessStatus|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  string $offer_id Unique identifier for an offer. (required)
     * @param  \Bolcom\Client\Model\UpdateOfferStockRequest $body body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\ProcessStatus|\Bolcom\Client\Model\Problem
     ...
     *
     * @param  string $offer_id Unique identifier for an offer. (required)
     * @param  \Bolcom\Client\Model\UpdateOfferStockRequest $body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\ProcessStatus|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
