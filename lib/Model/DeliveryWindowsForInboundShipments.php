 ...
 */
class DeliveryWindowsForInboundShipments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Delivery windows for inbound shipments.';
