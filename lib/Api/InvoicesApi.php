...
class InvoicesApi
{
    ...
    public function getInvoiceRequest($invoice_id)
    {
        ...
        if ($multipart) {
            $headers = $this->headerSelector->selectHeadersForMultipart(
                ['application/vnd.retailer.v6+json', 'application/vnd.retailer.v6+pdf']
            );
        } else {
    ...
    public function getInvoiceSpecificationRequest($invoice_id, $page = null)
    {
        ...
        if ($multipart) {
            $headers = $this->headerSelector->selectHeadersForMultipart(
                ['application/vnd.retailer.v6+json', 'application/vnd.retailer.v6+pdf', 'application/vnd.retailer.v6+openxmlformats-officedocument.spreadsheetml.sheet']
            );
        } else {
            $headers = $this->headerSelector->selectHeaders(
                ['application/vnd.retailer.v6+json', 'application/vnd.retailer.v6+pdf', 'application/vnd.retailer.v6+openxmlformats-officedocument.spreadsheetml.sheet'],
