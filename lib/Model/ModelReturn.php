...
class ModelReturn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'return_items' => '\BolApi\Client\Model\ReturnItem[]'
    ];
     ...
     * Sets return_id
     *
     * @param int|null $return_id Unique identifier for a return.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $registration_date_time The date and time in ISO 8601 format when this return was registered.
     *
     * @return self
     */
     ...
     *
     * @param string|null $fulfilment_method Specifies whether this shipment has been fulfilled by the retailer (FBR) or fulfilled by bol.com (FBB). Defaults to FBR.
     *
     * @return self
     */
     ...
     * Gets return_items
     *
     * @return \BolApi\Client\Model\ReturnItem[]
     */
     ...
     * Sets return_items
     *
     * @param \BolApi\Client\Model\ReturnItem[] $return_items return_items
     *
     * @return self
     */
