...
class OrdersApi
{
     ...
     *
     * @param  \Bolcom\Client\Model\ContainerForTheOrderItemsThatHaveToBeCancelled $body body (optional)
     *
     ...
     * Cancel an order item by an order item id
     *
     * @param  \Bolcom\Client\Model\ContainerForTheOrderItemsThatHaveToBeCancelled $body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\Order|\Bolcom\Client\Model\Problem
     */
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\Order|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderWithHttpInfo($order_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bolcom\Client\Model\Order' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Bolcom\Client\Model\Order', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\Bolcom\Client\Model\Order';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\ReducedOrders
     */
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\ReducedOrders, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrdersWithHttpInfo($page = 1, $fulfilment_method = 'FBR')
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bolcom\Client\Model\ReducedOrders' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Bolcom\Client\Model\ReducedOrders', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Bolcom\Client\Model\ReducedOrders';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bolcom\Client\Model\ReducedOrders',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Ship order item
     *
     * @param  \Bolcom\Client\Model\ShipmentRequest $body body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\ProcessStatus|\Bolcom\Client\Model\Problem
     ...
     * Ship order item
     *
     * @param  \Bolcom\Client\Model\ShipmentRequest $body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\ProcessStatus|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
