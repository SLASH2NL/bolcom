...
class Stock implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param int|null $corrected_stock The amount of items in stock minus handled order and minus open orders. As compared to the stock you sent us. When this reaches zero, your offer will not be for sale on the shop.
     *
     * @return self
     */
