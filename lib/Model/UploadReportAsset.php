...
class UploadReportAsset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const SUB_STATUS_PROCESSING_SARTED = 'PROCESSING_SARTED';
    ...
    const SUB_STATUS_SELECTED_BY_OGISTIC = 'SELECTED_BY_OGISTIC';
    const SUB_STATUS_SELECTION_DEETED = 'SELECTION_DEETED';
    const SUB_STATUS_SELECTION_MEGED = 'SELECTION_MEGED';
    ...
    const SUB_STATUS_WAITING_FOR_LOBAL_ID = 'WAITING_FOR_LOBAL_ID';
