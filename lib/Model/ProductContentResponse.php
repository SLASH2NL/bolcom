...
class ProductContentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $internal_reference A user defined unique reference to identify the products in the upload.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The end status of the rejected attribute.
     *
     * @return self
     */
