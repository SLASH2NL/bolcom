...
class DeliveryOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets label_type
     *
     * @param string|null $label_type The type of the label, representing the way an item is being transported. MAILBOX is a mailbox package with delivery scan. MAILBOX_LIGHT is a mailbox package without delivery scan. PARCEL is a normal package.
     *
     * @return self
     */
