...
class ProductContentApi
{
     ...
     * @return \Bolcom\Client\Model\ValidationReportResponse|\Bolcom\Client\Model\Problem
     */
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\ValidationReportResponse|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getValidationReportWithHttpInfo($upload_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bolcom\Client\Model\ValidationReportResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Bolcom\Client\Model\ValidationReportResponse', []),
            ...
            $returnType = '\Bolcom\Client\Model\ValidationReportResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bolcom\Client\Model\ValidationReportResponse',
     ...
     *
     * @param  \Bolcom\Client\Model\CreateProductContentRequest $body body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Post product content
     *
     * @param  \Bolcom\Client\Model\CreateProductContentRequest $body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
