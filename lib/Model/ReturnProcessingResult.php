...
class ReturnProcessingResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets quantity
     *
     * @param int|null $quantity The processed quantity.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $processing_date_time The date and time in ISO 8601 format when the return was processed.
     *
     * @return self
     */
