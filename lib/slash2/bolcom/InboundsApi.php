...
class InboundsApi
{
     ...
     * @return \Bolcom\Client\Model\DeliveryWindowsForInboundShipments|\Bolcom\Client\Model\Problem
     */
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\DeliveryWindowsForInboundShipments|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDeliveryWindowsWithHttpInfo($delivery_date = 'Today's date.', $items_to_send = 1)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bolcom\Client\Model\DeliveryWindowsForInboundShipments' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Bolcom\Client\Model\DeliveryWindowsForInboundShipments', []),
            ...
            $returnType = '\Bolcom\Client\Model\DeliveryWindowsForInboundShipments';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bolcom\Client\Model\DeliveryWindowsForInboundShipments',
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\Inbound|\Bolcom\Client\Model\Problem|\Bolcom\Client\Model\Problem
     */
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\Inbound|\Bolcom\Client\Model\Problem|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboundWithHttpInfo($inbound_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bolcom\Client\Model\Inbound' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Bolcom\Client\Model\Inbound', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Bolcom\Client\Model\Inbound';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\TransportersResponse
     */
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\TransportersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboundTransportersWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bolcom\Client\Model\TransportersResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Bolcom\Client\Model\TransportersResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Bolcom\Client\Model\TransportersResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bolcom\Client\Model\TransportersResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bolcom\Client\Model\Inbounds|\Bolcom\Client\Model\Problem
     */
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\Inbounds|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboundsWithHttpInfo($reference = null, $bsku = null, $creation_start_date = null, $creation_end_date = null, $state = null, $page = 1)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bolcom\Client\Model\Inbounds' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Bolcom\Client\Model\Inbounds', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Bolcom\Client\Model\Inbounds';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     *
     * @param  \Bolcom\Client\Model\ProductLabelsRequest $body body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string[]|\Bolcom\Client\Model\Problem|\Bolcom\Client\Model\Problem
     ...
     * Get inbound product labels by EAN
     *
     * @param  \Bolcom\Client\Model\ProductLabelsRequest $body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string[]|\Bolcom\Client\Model\Problem|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \Bolcom\Client\Model\InboundRequest $body body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Post inbound shipment
     *
     * @param  \Bolcom\Client\Model\InboundRequest $body (optional)
     *
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
