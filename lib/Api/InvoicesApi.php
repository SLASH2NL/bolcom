...
class InvoicesApi
{
    ...
    public function getInvoiceRequest($invoice_id)
    {
        ...
        if ($multipart) {
            $headers = $this->headerSelector->selectHeadersForMultipart(
                ['application/vnd.retailer.v5+json', 'application/vnd.retailer.v5+pdf']
            );
        } else {
    ...
    public function getInvoiceSpecificationRequest($invoice_id, $page = null)
    {
        ...
        if ($multipart) {
            $headers = $this->headerSelector->selectHeadersForMultipart(
                ['application/vnd.retailer.v5+json', 'application/vnd.retailer.v5+pdf', 'application/vnd.retailer.v5+openxmlformats-officedocument.spreadsheetml.sheet']
            );
        } else {
            $headers = $this->headerSelector->selectHeaders(
                ['application/vnd.retailer.v5+json', 'application/vnd.retailer.v5+pdf', 'application/vnd.retailer.v5+openxmlformats-officedocument.spreadsheetml.sheet'],
