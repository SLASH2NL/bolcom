 ...
 */
class RetailPriceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RetailPriceResponse';
    ...
    {
        $this->container['retail_prices'] = $data['retail_prices'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['retail_prices'] === null) {
            $invalidProperties[] = "'retail_prices' can't be null";
        }
