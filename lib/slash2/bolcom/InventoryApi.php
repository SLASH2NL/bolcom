...
class InventoryApi
{
     ...
     * @param  string[] $quantity Filter inventory by providing a range of quantity (min-range)-(max-range). (optional)
     ...
     * @return \Bolcom\Client\Model\InventoryResponse|\Bolcom\Client\Model\Problem
     */
     ...
     * @throws \Bolcom\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bolcom\Client\Model\InventoryResponse|\Bolcom\Client\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInventoryWithHttpInfo($page = 1, $quantity = null, $stock = null, $state = null, $query = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bolcom\Client\Model\InventoryResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Bolcom\Client\Model\InventoryResponse', []),
            ...
            $returnType = '\Bolcom\Client\Model\InventoryResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bolcom\Client\Model\InventoryResponse',
